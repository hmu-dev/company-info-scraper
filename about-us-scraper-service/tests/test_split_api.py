...
class TestSAMSplitAPI:
    ...
    def test_scrape_media_endpoint_pagination(self, mock_extract_media, mock_get_content, client):
    ...
    def test_cursor_pagination_logic(self):
        ...
        if result["pagination"]["has_more"]:
            ...
            assert result2["pagination"]["current_page_start"] == result["pagination"]["current_page_end"]
    ...
    def test_media_endpoint_with_type_filter(self, client):
        ...
        with patch('main_split.get_page_content') as mock_get_content:
            ...
            with patch('main_split.extract_media_assets') as mock_extract:
                ...
                response = client.get("/scrape/media?url=test.com&media_type=image&limit=10")
