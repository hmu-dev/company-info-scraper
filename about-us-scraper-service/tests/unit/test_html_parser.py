...
def test_extract_media_special_characters():
    ...
    assert len(media) == 2
    assert ('https://example.com/image with spaces.jpg', 'image', 'Text with & and "') in media
    assert ('https://example.com/image%20with%20encoding.jpg', 'image', "Text with 'quotes'") in media