...
def test_lambda_handler_llm_metrics(mock_log_llm, mock_handler, mock_event, mock_context):
...
def test_lambda_handler_media_metrics(mock_log_media, mock_handler, mock_event, mock_context, mock_media_response):
...
def test_lambda_handler_cache_metrics(mock_log_cache, mock_handler, mock_event, mock_context, mock_cache_response):
