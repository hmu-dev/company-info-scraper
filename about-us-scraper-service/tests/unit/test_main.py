...
def test_compression_setup():
    ...
    with patch("api.middleware.compression.setup_compression") as mock_setup_compression:
        app = create_app()
...
def test_rate_limiting_setup():
    ...
    with patch("api.middleware.rate_limit.setup_rate_limiting") as mock_setup_rate_limiting:
        app = create_app()
