...
def generate_urls(max_total=200):
    industries = [
        "restaurant", "boutique", "plumbing", "coffee shop", "hair salon", "auto repair",
        "bakery", "florist", "gym", "bookstore", "pet store", "dentist", "real estate agent",
        "landscaping", "yoga studio", "photography", "accounting", "law firm", "catering",
        "event planning"
    ]
    all_urls = set()
    for industry in industries:
        ...
        with DDGS() as ddgs:
            ...
            urls = [r['href'] for r in results if 'href' in r and r['href'].startswith('http') and 'example' not in r['href'] and 'list' not in r['href']]
