...
version_manager.register_handler("1.0.0", "/media", media.scrape_media)
version_manager.register_handler("1.0.0", "/profile", profile.scrape_profile)

# Register v1.1 handlers (example of versioning)
version_manager.register_handler(
    "1.1.0",
    "/media",
    media.scrape_media,
    deprecation_notice="This version will be deprecated in v2.0.0. Please upgrade to v2.0.0 when available."
)
