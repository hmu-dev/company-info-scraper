...
class Cache:
    ...
    async def get(self, url: str, cache_type: str = "profile") -> Tuple[Optional[Dict[str, Any]], bool]:
        """
        Get item from cache
    ...
    async def set(self, url: str, data: Dict[str, Any], cache_type: str = "profile") -> bool:
        """Set item in cache"""
        start_time = time.time()
        try:
    ...
    async def get_or_set(self, url: str, getter: callable, cache_type: str = "profile") -> Tuple[Dict[str, Any], bool]:
        """
