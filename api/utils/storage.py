...
class MediaStorage:
    ...
    async def store_media(self, content: bytes, url: str, media_type: str) -> Tuple[str, Dict[str, str]]:
        """
    ...
    async def delete_media(self, url: str) -> bool:
        ...
        try:
            ...
            # Log deletion error
            log_event("media_delete_error", {
                "url": url,
                "error": str(e)
            })
            raise

    async def get_presigned_url(self, url: str, expires_in: int = 3600) -> Optional[str]:
        ...
        try:
            ...
            # Log URL generation
            log_event("presigned_url_generated", {
                "url": url,
    ...
    async def get_media_metadata(self, url: str) -> Optional[Dict[str, str]]:
        ...
        try:
            ...
            log_event("media_metadata_error", {
                "url": url,
                "error": str(e)
            })
            return None
